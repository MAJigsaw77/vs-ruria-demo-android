...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('characters/GF_assetsMinus');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'ruria':
				...
				playAnim("idle");
			case 'ruria-':
				frames = Paths.getSparrowAtlas('characters/ruriaMinus','shared');
			...
			case 'bf':
				...
				flipX = true;
			case 'bf2':
				var tex = Paths.getSparrowAtlas('characters/BFReanimated','shared');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
				...
				animation.addByPrefix('ouch', 'Boyfriend_Hit', 24, false);
				...
				flipX = true;
			case 'bf-':
				var tex = Paths.getSparrowAtlas('characters/BOYFRIENDMinus');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
